...
2. **Search for related work** using available tools:
   ...
   - Read `Bibliography.bib` for papers already in the project

3. **Organize findings** into these categories:
   - **Theoretical contributions** -- models, frameworks, mechanisms
   - **Empirical/computational findings** -- key results, simulation outcomes
   - **Methodological innovations** -- new techniques, algorithms
   - **Open debates** -- unresolved disagreements in the literature

4. **Identify gaps and opportunities:**
   - What questions remain unanswered?
   - What models or methods could address them?
...
- **Method:** [Model / simulation / analytical]
- **Key finding:** [Result]
...
- **Do NOT fabricate citations.** Flag anything uncertain for user verification.

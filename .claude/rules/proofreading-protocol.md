...
4. **Consistency** -- notation, citation style, terminology, figure/table references
5. **Style compliance** -- Julian's writing conventions (voice, hedging, structure)
...
2. Produces a **report** with every proposed change:
   ...
   - Current text
   - Proposed fix
   - Category (grammar / typo / overflow / consistency / style)
3. Saves report to `quality_reports/` (e.g., `quality_reports/paper_name_report.md`)

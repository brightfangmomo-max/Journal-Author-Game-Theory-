...
2. **Create folder** -- `mkdir -p explorations/[name]/{python,julia,output}` + README + SESSION_LOG.md
3. **Code immediately** -- no plan needed. Must-haves: code runs, results correct, goal documented. Not needed: full docstrings, perfect style.
